...
namespace Attargah\AntiScam\Resources\BlockedIpLogs;

use Attargah\AntiScam\Models\BlockedIpLog;
use Attargah\AntiScam\Resources\BlockedIpLogs\Pages\ManageBlockedIpLogs;
use BackedEnum;
...
class BlockedIpLogResource extends Resource
{
    ...
    {
        return [
            'index' => ManageBlockedIpLogs::route('/'),
        ];
    }
}
